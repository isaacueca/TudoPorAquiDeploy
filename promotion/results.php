<?
	...
	$sitecontentSection = "Promotion Results";
	...
	unset($searchReturn);
	$searchReturn = search_frontPromotionSearch($_GET, "promotion");
	$pageObj = new pageBrowsing($searchReturn["from_tables"], $screen, 10, $searchReturn["order_by"], "Promotion.name", $letra, $searchReturn["where_clause"], $searchReturn["select_columns"], "Promotion", $searchReturn["group_by"]);
	...
	if (EDIR_THEME) {
		...
		include(EDIRECTORY_ROOT."/frontend/body/promotion_results.php");
	}
