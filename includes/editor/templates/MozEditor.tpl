...
config_##name##.border_visible = ##categoriaslines##;
config_##name##.doctype = '##doctype##';
config_##name##.charset = '##charset##';
// lang
config_##name##.lang['categoriaslines_hidden'] = '##categoriaslines_hidden##';
config_##name##.lang['categoriaslines_visible'] = '##categoriaslines_visible##';
			...
			<table id="##name##_tab_table" class="wpTabHolder" width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					...
					<td width="100%" class="wpTabNoTab"><div class="wpStyled" align="right"><span id="##name##_moremessages">##br_tag##</span> &nbsp;
							<span id="##name##_messages" class="wpBorderMessage" onclick="wp_toggle_table_borders(##name##,this);" title="##toggle_categoriaslines##" onMouseOver="this.style.textDecoration='underline'" onMouseOut="this.style.textDecoration='none'"></span></div></td>
				</tr>
			</table>
			<!-- begin hidden stuff ---------------------------------------------------------------------------------------------------->
			<div id="##name##_hidden">
