...
function wp_show_borders(obj) {
	...
	if (message.innerHTML != obj.lng['categoriaslines_visible']) {
		message.innerHTML = obj.lng['categoriaslines_visible']
	}
...
function wp_hide_borders(obj) {
	...
	var message = document.getElementById(obj.id + '_messages')
	if (message.innerHTML != obj.lng['categoriaslines_hidden']) {
		message.innerHTML = obj.lng['categoriaslines_hidden']
	}
	message.style.textDecoration = 'none'
}
/////////////////////////////
