...
class wysiwygPro {
	...
	*/
	...
	/***************************************************************************
	 categoriaslines_visible
	 Public: sets whether categoriaslines are on by default
	 $show: true means they are false means theyre not
	 
	*/
	
	function categoriaslines_visible($show = true) {
		if ($this->has_expired) {
			if ($show) {
				$this->categoriaslines = '1';
			} else {
				$this->categoriaslines = '0';
			}
		}
	}
...
';
			...
			$this->WYSIWYGPRO_code = $this->wp_replace($this->WYSIWYGPRO_code, array(  
				...
				'secure' => $secure,
				'categoriaslines' => $this->categoriaslines,
				'name' => $this->name,
				...
				'br_tag' => $lang['br_tag'],
				'toggle_categoriaslines' => $lang['toggle_categoriaslines'],
				...
				// javascript
				'categoriaslines_hidden' => $lang['categoriaslines_hidden'],
				'categoriaslines_visible' => $lang['categoriaslines_visible'],
