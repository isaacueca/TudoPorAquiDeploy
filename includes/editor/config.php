...
define('WP_WEB_DIRECTORY', DEFAULT_URL.'/includes/editor/');
...
define('IMAGE_FILE_DIRECTORY', EDIRECTORY_ROOT."/custom/editor_files/");
...
define('IMAGE_WEB_DIRECTORY', DEFAULT_URL."/custom/editor_files/");
...
define('NOCACHE', false);                                 // whether to send nocache headers to prevent proxy servers from sending the wrong content to browsers
