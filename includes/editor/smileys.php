...
<table width="100%" border="0" cellpadding="4" cellspacing="1" align="center">
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley1.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['smile']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley9.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['embarrassed']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley2.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['wink']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley10.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['star']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley3.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['shocked']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley11.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['dead']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley4.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['big_smile']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley12.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['sleepy']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley5.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['confused']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley13.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['disapprove']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley6.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['unhappy']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley14.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['approve']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley7.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['angry']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley15.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['evil_smile']; ?></td>
	</tr>
	<tr> 
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley8.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
			<?php echo $lang['clown']; ?></td>
		<td width="50%" class="text"><img src="<?php echo WP_WEB_DIRECTORY; ?>images/smileys/smiley16.gif" width="17" height="17" border="0" align="absmiddle" alt="" title="" /> 
