<?php
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/code/eventcategory.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		if (validate_form("eventcategory", $_POST, $message_category)) {
	...
	# ----------------------------------------------------------------------------------------------------
	if ($id) {
		$category = db_getFromDB("eventcategory", "id", $id);
		$category->extract();
	...
	$fatherCategoryObj = new EventCategory($category_id);
