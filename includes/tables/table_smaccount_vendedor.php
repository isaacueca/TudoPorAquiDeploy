...
<table>
	...
	<? foreach($smaccount as $smaccount) { ?>
		...
		<tr class="tr-table">
			<td class="td-table">
				<a class="tooltip" href="<?=DEFAULT_URL?>/gerenciamento/administradores-vendedores/visualizar/<?=$smaccount->getNumber("id")?>" class="link-table">
			...
			<td class="td-table" nowrap>
				...
				<a class="tooltip"  title="<?=system_showText(LANG_SITEMGR_VIEW)?>" href="<?=DEFAULT_URL?>/gerenciamento/administradores-vendedores/visualizar/<?=$smaccount->getNumber("id")?>" class="link-table">
					<img src="<?=DEFAULT_URL?>/images/bt_view.gif" alt="<?=system_showText(LANG_SITEMGR_VIEW)?>" border="0" />
				</a>

				<a class="tooltip"  title="<?=system_showText(LANG_SITEMGR_EDIT)?>" href="<?=DEFAULT_URL?>/gerenciamento/administradores-vendedores/editar/<?=$smaccount->getNumber("id")?>" class="link-table">
				...
				<? } else { ?>
					<a class="tooltip"  title="<?=system_showText(LANG_SITEMGR_DELETE)?>" href="<?=DEFAULT_URL?>/gerenciamento/administradores-vendedores/apagar/<?=$smaccount->getNumber("id")?>" class="link-table">
