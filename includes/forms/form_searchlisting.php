		...
		<tr>
			...
			<td>
				<table style="width: auto;">
					<tr>
					<td class="td-checkbox"><input type="radio" name="search_level" value="1" class="inputCheck" /></td>
					<td><span class="label-field-form">Utilidade Pública</span></td>
                    <td class="td-checkbox"><input type="radio" name="search_level" value="2" class="inputCheck" /></td>
					<td><span class="label-field-form">Gratuito</span></td>
                    <td class="td-checkbox"><input type="radio" name="search_level" value="3" class="inputCheck" /></td>
					<td><span class="label-field-form">Assinante</span></td>
