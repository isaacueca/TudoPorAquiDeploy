...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table" style="margin-top: 15px;">
	...
	<tr>
		<th><?=system_showText(LANG_SITEMGR_EVENT_EVENTTITLE)?>:</th>
	...
	<? } ?>
		<tr>
			...
			<input type="text" name="search_date_period1" value="<?=$search_date_period1?>" style="width:80px;" maxlength="10" /><a href="javascript:void(0);" onclick="cal_date_period1.popup()" title="<?=system_showText(LANG_SITEMGR_CLICKHERETOSELECTSTARTDATE)?>"><img src="<?=DEFAULT_URL?>/images/calendar/cal.gif" alt="<?=system_showText(LANG_SITEMGR_LABEL_CALENDAR)?>" title="<?=system_showText(LANG_SITEMGR_LABEL_CALENDAR)?>" border="0" class="iconAlign" /></a>
			&nbsp;<?=strtolower(system_showText(LANG_SITEMGR_LABEL_TO))?>:&nbsp;
			<input type="text" name="search_date_period2" value="<?=$search_date_period2?>" style="width:80px;" maxlength="10" /><a href="javascript:void(0);" onclick="cal_date_period2.popup()" title="<?=system_showText(LANG_SITEMGR_CLICKHERETOSELECTENDDATE)?>"><img src="<?=DEFAULT_URL?>/images/calendar/cal.gif" alt="<?=system_showText(LANG_SITEMGR_LABEL_CALENDAR)?>" title="<?=system_showText(LANG_SITEMGR_LABEL_CALENDAR)?>" border="0" class="iconAlign" /></a>
