<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_worldpaysettings.php
	# ----------------------------------------------------------------------------------------------------
...
?>
	...
	<div id="header-form">
		<?=ucwords(system_showText(LANG_SITEMGR_SETTINGS_PAYMENT_WORLDPAYINFORMATION))?>
	</div>
	...
	<tr class="tr-form">
		...
		<td align="left" class="td-form">
			<input type="text" name="worldpay_instid" value="<?=$worldpay_instid?>" class="input-form-adminemail" />
		</td>
	</tr>
	...
	<table style="margin: 0 auto 0 auto;">
		<tr>
			<td>
				<button type="button" name="bt_submit_worldpay" value="Submit" class="ui-state-default ui-corner-all" onClick="formSubmit('worldpay')"><?=system_showText(LANG_SITEMGR_SUBMIT)?></button>
			</td>
		</tr>
	</table>
