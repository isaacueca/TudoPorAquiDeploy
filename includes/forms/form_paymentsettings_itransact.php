<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_itransactsettings.php
	# ----------------------------------------------------------------------------------------------------
...
?>
	...
	<div id="header-form">
		<?=ucwords(system_showText(LANG_SITEMGR_SETTINGS_PAYMENT_ITRANSACTINFORMATION))?>
	</div>
	...
	<tr class="tr-form">
		...
		<td align="left" class="td-form">
			<input type="text" name="itransact_vendorid" value="<?=$itransact_vendorid?>" class="input-form-adminemail" />
		</td>
	</tr>
	...
	<table style="margin: 0 auto 0 auto;">
		<tr>
			<td>
				<button type="button" name="bt_submit_itransact" value="Submit" class="ui-state-default ui-corner-all" onClick="formSubmit('itransact')"><?=system_showText(LANG_SITEMGR_SUBMIT)?></button>
			</td>
		</tr>
	</table>
