...
<div id="header-form"><?=system_showText(LANG_SITEMGR_MODIFY)?> <?=system_showText(LANG_SITEMGR_CLASSIFIED_SING)?> <?=ucwords(system_showText(LANG_SITEMGR_MENU_SETTINGS))?> - <?=$classifiedObj->getString("title")?></div>
		...
		<? if (PAYMENT_FEATURE == "on") { ?>
			<? if (MANUALPAYMENT_FEATURE == "on") { ?>
				...
				<div id="trans_form" class="base-table-form-account" style="display: <?=(($_POST["add_transaction"] == "1") ? "block" : "none" )?>;">
					...
					<?
					$acct_search_table_title = system_showText(LANG_SITEMGR_ACCOUNTSEARCH_SELECT)."".system_showText(LANG_SITEMGR_CLASSIFIED_SING);
