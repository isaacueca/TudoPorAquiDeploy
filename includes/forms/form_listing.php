...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table" >
	<tr>
		<th colspan="2" class="standard-tabletitle">Selecione o nível do estabelecimento</th>
	</tr>
    ...
    <tr><td colspan="2">
         <br />
                                ...
                                <table align="left" >  
                                <tr>
                                   <td style="vertical-align:top; width: auto;"><input type="radio" name="tipo_assinante" <? if (($tipo_assinante=="1")) echo "checked"?> value="1" /></td><td style="width: auto;"><b>Utilidade Pública</b><br />Neste nível cadastram-se os estabelecimento públicos(ligados a administração pública Federal, Estadual, Municipal) e os de Utilidade Pública. </td>
                                </tr> 
                                <tr>
                                <td style="vertical-align:top; width: 30px;"><input type="radio" name="tipo_assinante" <? if (($tipo_assinante=="2")) echo "checked"?> value="2" /></td><td style="width: auto;"><b>Gratuito</b><br />Neste nível os estabelecimento podem cadastrar seus dados básicos, tais como – Nome de Fantasia, Razão Social, CNPJ ou CPF, Endereço físico, Endereço na internet (www) e e-mail e se inscrever em uma Categoria.</td>
                                   </tr> 
                                   <tr>
	                               <td style="width: auto;"></td><td style="width: 600px;" align="left"><b>Assinatura</b><br />Neste nível os estabelecimentos podem, além de cadastrar os dados básicos, acessar relatórios, criar galeria de fotos, criar promoções, cadastrar clientes, utilizar blog, e uma melhor colocação no resultado da buscas.
     	                          </tr>  
      
                                   <tr>
                                    <td style="vertical-align:top; width: auto;"><input type="radio" name="tipo_assinante" <? if ((($tipo_assinante=="30") || ($tipo_assinante == "")) && ($level != "10")) echo "checked"?> value="30" /></td><td style="width: 600px;"><b>Mensal</b>&nbsp;–&nbsp;R$&nbsp;50,00</td>
                                   </tr>
                                   <tr>
                                    <td style="vertical-align:top; width: auto;"><input type="radio" name="tipo_assinante" <? if (($tipo_assinante=="90") && ($level != "10")) echo "checked"?> value="90" /></td><td style="width: 600px;"><b>Trimestral</b>&nbsp;–&nbsp;R$&nbsp;135,00</td>
                                    </tr>
                                   <tr>
                                    <td style="vertical-align:top; width: auto;"><input type="radio" name="tipo_assinante" <? if (($tipo_assinante=="180") && ($level != "10")) echo "checked"?> value="180" /></td><td style="width: 600px;"><b>Semestral</b>&nbsp;–&nbsp;R$&nbsp;255,00</td>
                                 </tr>
                                  <tr>
                                    <td style="vertical-align:top; width: auto;"><input type="radio" name="tipo_assinante" <? if (($tipo_assinante=="360") && ($level != "10")) echo "checked"?> value="360" /></td><td width="10px"><b>Anual</b>&nbsp;–&nbsp;R$&nbsp;500,00</td>
                                 </tr> 
    ...
    <td colspan="2" width="600px">
             <table width="600px" align="left">
                 <tr><td style="width: auto;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Escolha o dia de vencimento que o sistema gerará o boleto de cobrança bancária.</td></tr>
             </table>
             <table width="600px" align="left">
                 <tr>       
                    <td></td>
                    <td><input type="radio" name="dia_vencimento" <? if (($dia_vencimento=="5") | ($dia_vencimento == "")) echo "checked"?> value="5" /></td><td>05</td>
                    <td><input type="radio" name="dia_vencimento" <? if ($dia_vencimento=="10") echo "checked"?> value="10" /></td><td>10</td>
                    <td><input type="radio" name="dia_vencimento" <? if ($dia_vencimento=="15") echo "checked"?> value="15" /></td><td>15</td>
                    <td><input type="radio" name="dia_vencimento" <? if ($dia_vencimento=="20") echo "checked"?> value="20" /></td><td>20</td>
                    <td><input type="radio" name="dia_vencimento" <? if ($dia_vencimento=="25") echo "checked"?> value="25" /></td><td>25</td>
                    <td><input type="radio" name="dia_vencimento" <? if ($dia_vencimento=="30") echo "checked"?> value="30" /></td><td>30</td>
                 </tr>                                                  
             </table>
            <table>
                <tr>
                    <td style="width: auto; visibility:hidden"><input type="checkbox" name="envio_boleto_email" <? if (($envio_boleto_email=="1")|($dia_vencimento=="")) echo "checked"?> value="1" /></td><td style="width: auto; visibility:hidden">Enviar&nbsp;email&nbsp;com&nbsp;o&nbsp;boleto&nbsp;10&nbsp;dias&nbsp;antes&nbsp;do&nbsp;vencimento.</td>
                </tr>
            </table>
    </td></tr>
	...
	<tr>
		...
		<tr>
			...
			<td><input type="text" style="width:400px" name="url" value="<?=str_replace($protocol_replace, "", $url)?>" maxlength="255" /></td>
		</tr>
        <tr>
	...
	<tr>
       ...
       <tr>
			<th style="width:2000px">Habilitar Facebook:</th>
			<td><input type="checkbox" name="facebook" /></td>
		</tr>
</table>
		...
		<td colspan="2" style="width:auto; margin: 0px; padding: 0px;">
			...
			<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; margin: 0; padding: 0">
				<tr>
					...
					<td class="innerCell">
						<input style="width:200px" type="text" name="newcity" onBlur="easyFriendlyUrl(this.value, 'newcity_friendly_url', '<?=FRIENDLYURL_VALIDCHARS?>', '<?=FRIENDLYURL_SEPARATOR?>');" />
