	...
	<? if ($articleObj->hasRenewalDate()) { ?>
		<tr class="tr-form">
			...
			<td align="left" class="td-form">
				...
				?>
				&nbsp;<a href="javascript:void(0);" title="preencher automaticamente data de renovação" onclick="document.getElementById('renewal_date').value='<?=$renewal_date; ?>'"><?=system_showText(LANG_SITEMGR_RENEWALDATE_AUTOFILL)?></a>
