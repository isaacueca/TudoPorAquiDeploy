...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table">
	...
	<tr>
		<th style="width:200px" class="wrap">
			<?
			if (LISTINGTEMPLATE_FEATURE == "on") {
				echo "* ".(($template_title_field!==false) ? $template_title_field[0]["label"] : "".system_showText("Razão Social")).":";
			} else {
	...
	<? if ($level > "10") { ?>
		 <tr>
			<th style="width:200px">Nome da Fantasia :</th>
			<td><input style="width:400px" type="text" name="razaosocial" value="<?=$cnpj?>" maxlength="50" /></td>
		</tr>
        <tr>
