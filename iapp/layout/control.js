...
(function() {
	...
	$i.onload = {
		...
		enableLinksOnTap : function() {
			...
			var itemsView = document.querySelectorAll("#content .itemViewDetail");
			for (var i = 0, j = itemsView.length; i < j; i++) {
				var itemView = itemsView[i];
				
				// On touch
				itemView.addEventListener("touchstart", function(e) {
					var _this = this;
				...
				// On finger scroll
				itemView.addEventListener("touchmove", function(e) {
				...
				// On finger up
				itemView.addEventListener("touchend", function(e) {
