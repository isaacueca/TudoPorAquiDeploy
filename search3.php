<?
      ...
      /*  include("class.ipdetails.php");
                       ...
                       //  echo 'Cidade: '.$state_name;
                       //echo 'Estado: '.$country_name;
...
<td>
<fieldset>
			   <div style="height:27px">	<label><?=system_showText("Localidade");?> </label></div>
...
<table>
		...
		<!-- 								<td align="left" class="td-form">
			...
			<input type="hidden" name="template_id" id="templateIDID" value="<?=$template_id;?>" />
             ...
             <div style="float:right; margin-right:24px; margin-top:10px"><a href="javascript:if (document.forms[0].keyword.value != '') document.forms[0].submit(); else alert('O campo Palavra-chave deve ser preenchido');"><img  src="images/buscarbtn.gif" border="0" ></a></div>
		</form>
