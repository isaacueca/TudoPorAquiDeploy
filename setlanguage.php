<?
	...
	if ($_COOKIE["edir_language"]) {
		setcookie("edir_language", $_COOKIE["edir_language"], time() + $expire, EDIRECTORY_FOLDER);
	}
	if ($_GET["lang"]) {
		setcookie("edir_language", $_GET["lang"], time() + $expire, EDIRECTORY_FOLDER);
	} else {
		setcookie("edir_language", "", time() - $expire, EDIRECTORY_FOLDER);
	}
