<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/classifiedcategs/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("ClassifiedCategory", $screen, 10, "title, id", "title", $letra, "category_id = ".db_formatNumber($category_id)."");
	$categories = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/gerenciamento/classifiedcategs/index.php?category_id=".$category_id;
...
<div id="main-right">
	...
	<div id="top-content">
		<div id="header-content">
			<h1><?=ucwords(system_showText(LANG_SITEMGR_CLASSIFIED_PLURAL))?> - <?=ucwords(system_showText(LANG_SITEMGR_CATEGORIES))?> </h1>
		</div>
	</div>
	...
	<div id="content-content">
		...
		<div class="default-margin" style="padding-top:3px;">
			...
			<? include(INCLUDES_DIR."/tables/table_classifiedcategory.php"); ?>
