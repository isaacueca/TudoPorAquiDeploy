<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/eventcategs/category.php
	# ----------------------------------------------------------------------------------------------------
	...
	# CODE
	# ----------------------------------------------------------------------------------------------------
	include(INCLUDES_DIR."/code/eventcategory.php");
	...
	<div id="content-content">
		<div class="default-margin" style="padding-top:3px;">
			...
			<form name="category" action="<?=$_SERVER["PHP_SELF"]?>" method="post">
				...
				<div id="header-form"><?=ucwords(system_showText(LANG_SITEMGR_EVENT_PLURAL))?> - <?=system_showText(LANG_SITEMGR_CATEGORY_INFORMATION)?></div>
				<? if ($message_category) { ?>
					<div class="response-msg error ui-corner-all"><?=$message_category?></div>
				<? } ?>

				<? include(INCLUDES_DIR."/forms/form_eventcategory.php"); ?>
