<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/eventcategs/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("EventCategory", $screen, 10, "title, id", "title", $letra, "category_id = ".db_formatNumber($category_id)."");
	$categories = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/gerenciamento/eventcategs/index.php?category_id=".$category_id;
...
<div id="main-right">
	...
	<div id="top-content">
		<div id="header-content">
			<h1><?=system_showText(LANG_SITEMGR_NAVBAR_EVENT)?> - <?=ucwords(system_showText(LANG_SITEMGR_CATEGORIES))?> </h1>
		</div>
	</div>
	...
	<div id="content-content">
		...
		<div class="default-margin" style="padding-top:3px;">
			...
			<? include(INCLUDES_DIR."/tables/table_eventcategory.php"); ?>
