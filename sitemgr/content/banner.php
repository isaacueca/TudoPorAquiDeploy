<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/content/banner.php
	# ----------------------------------------------------------------------------------------------------
	...
	# PAGE BROWSING
	# ----------------------------------------------------------------------------------------------------
	$pageObj  = new pageBrowsing("Content", $screen, 20, "id", "id", $letra, "section = 'banner'");
	$contents = $pageObj->retrievePage();

	# PAGES DROP DOWN ----------------------------------------------------------------------------------------------
	$paging_url = DEFAULT_URL."/gerenciamento/content/banner.php";
	...
	?>
		...
		<div id="page-wrapper">
			...
			<table class="table-table">
				...
				<tr class="th-table">
					<td class="td-th-table"><?=ucwords(system_showText(LANG_SITEMGR_BANNER))?> <?=strtolower(system_showText(LANG_SITEMGR_TYPEADVERTISEMENT))?></td>
				...
				?>
					<tr class="tr-table">
						<td class="td-table">
							<a href="<?=DEFAULT_URL?>/gerenciamento/content/contentlevel.php?section=banner&value=<?=$value?>" class="link-table">
