<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/classifiedcategs/delete.php
	# ----------------------------------------------------------------------------------------------------
	...
	if ($id) {
		...
		header("Location: ".DEFAULT_URL."/gerenciamento/classifiedcategs/".(($search_page) ? "search.php" : "index.php")."?message=".urlencode($message)."&category_id=".$category_id."&screen=$screen&letra=$letra".(($url_search_params) ? "&$url_search_params" : "")."");
		exit;
	}
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<form name="classified" action="<?=$_SERVER["PHP_SELF"]?>" method="post">
