<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/classified/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Classified", $screen, 10, (($_GET["newest"])?("id DESC"):((CLASSIFIED_SCALABILITY_OPTIMIZATION == "on")?(""):("level DESC, title"))), "title", $letra);
	$classifieds = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/gerenciamento/classified/index.php";
