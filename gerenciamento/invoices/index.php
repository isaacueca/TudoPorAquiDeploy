<?
	...
	if($invoiceStatusObj->getDefault())   $sql_where[] = " Invoice.id = Invoice_Listing.invoice_id and status != '".$invoiceStatusObj->getDefault()."' ";
	if ($sql_where)                       $where .= " ".implode(" AND ", $sql_where)." ";

	$pageObj  = new pageBrowsing("Invoice, Invoice_Listing",$screen,10,"date DESC","","", $where);
