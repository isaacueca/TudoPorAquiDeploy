<?
	...
	check_action_permission('vendedores', 'view');
	...
	foreach ($locais as $local){
		$sql_where[] = "localidades like '%$local%'";
	}
	
	if ($sql_where) {
		$sqlwhere .= "admin_type='vendedor' AND (";
		$sqlwhere .= " ".implode(" OR ", $sql_where)." ";
		$sqlwhere .= ")";
	}
	
	// Page Browsing ////////////////////////////////////////
	$pageObj = new pageBrowsing("SMAccount", $screen, 1000, (($_GET["newest"])?("id DESC"):("username")), "username", $letra, $sqlwhere);
				...
				<div id="main-content"> 
					...
					<div class="page-title ui-widget-content ui-corner-all">
						...
						<div class="other_content">
							...
							<? if ($smaccount) { ?>
								<? include(INCLUDES_DIR."/tables/table_smaccount_vendedor.php"); ?>
								<? } else { ?>
