<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /gerenciamento/content/listing.php
	# ----------------------------------------------------------------------------------------------------
	...
	# PAGE BROWSING
	# ----------------------------------------------------------------------------------------------------
	$pageObj  = new pageBrowsing("Content", $screen, 20, "id", "id", $letra, "section = 'listing'");
	$contents = $pageObj->retrievePage();

	# PAGES DROP DOWN ----------------------------------------------------------------------------------------------
	$paging_url = DEFAULT_URL."/gerenciamento/content/listing.php";
	...
	?>
		...
		<div id="page-wrapper">
			...
			<table class="table-table">
				...
				<tr class="th-table">
					<td class="td-th-table"><?=ucwords(system_showText(LANG_SITEMGR_LISTING))?> <?=strtolower(system_showText(LANG_SITEMGR_LEVELADVERTISEMENT))?></td>
				...
				foreach ($levelValue as $value) {
					...
					<tr class="tr-table">
						<td class="td-table">
							<a href="<?=DEFAULT_URL?>/gerenciamento/content/contentlevel.php?section=listing&value=<?=$value?>" class="link-table">
