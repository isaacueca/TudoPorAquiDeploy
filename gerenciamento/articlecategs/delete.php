<?
	...
	if ($id) {
		...
		header("Location: ".DEFAULT_URL."/gerenciamento/articlecategs/".(($search_page) ? "search.php" : "index.php")."?message=".urlencode($message)."&category_id=".$category_id."&screen=$screen&letra=$letra".(($url_search_params) ? "&$url_search_params" : "")."");
		exit;
	}
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<form name="article" action="<?=$_SERVER["PHP_SELF"]?>" method="post">
				...
				<div id="header-form"><?=system_showText(LANG_SITEMGR_CATEGORY_DELETECATEGORY)?> - <?=$category->getString("title")?></div>
				...
				<button type="submit" class="ui-state-default ui-corner-all"><?=system_showText(LANG_SITEMGR_YES)?></button>

			</form>
			<form action="<?=DEFAULT_URL?>/gerenciamento/articlecategs/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
