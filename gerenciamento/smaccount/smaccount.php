<?
	...
	check_action_permission('admin_geral', 'add');
	...
	/*	$items =  $_POST['selected_items'];
		...
		if (validate_smaccount($_POST, $message_smaccount)) {
			...
			$_POST["admin_type"] = 'admin_geral';
			$permission_actions = array(array('usuarios', '15'), array('admin_geral', '15'), array('admin_comercial', '15'),array('admin_local', '15'),array('vendedores', '15'),array('estabelecimentos', '31'), array('investidores', '15'), array('categorias', '15'),array('banners', '31'), array('estados', '15'),array('cidades', '15'),array('bairros', '15'),array('pagamento_faturas', '31'),array('relatorio_de_estatistica','15'));
