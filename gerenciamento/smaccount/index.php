<?
	...
	check_action_permission('admin_geral', 'view');
	...
	// Page Browsing ////////////////////////////////////////
	$pageObj = new pageBrowsing("SMAccount", $screen, 1000, (($_GET["newest"])?("id DESC"):("username")), "username", $letra, "admin_type='admin_geral'");
