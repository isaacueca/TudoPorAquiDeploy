<?
	...
	// Page Browsing ////////////////////////////////////////
	$pageObj = new pageBrowsing("SMAccount", $screen, 1000, (($_GET["newest"])?("id DESC"):("username")), "username", $letra, "admin_type='investidor'");
	...
	?>
		...
		<? include(INCLUDES_DIR."/tables/table_smaccount_investidor_submenu.php"); ?>
