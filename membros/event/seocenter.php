<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /membros/event/seocenter.php
	# ----------------------------------------------------------------------------------------------------
...
?>
			...
			<div class="mainContentExtended">
				...
				<h1 class="standardTitle"><?=ucwords(EVENT_FEATURE_NAME);?> SEO CENTER - <span><?=$event->getString("title");?></span></h1>

				<form name="eventseocenter" action="<?=$_SERVER["PHP_SELF"]?>" method="post">
